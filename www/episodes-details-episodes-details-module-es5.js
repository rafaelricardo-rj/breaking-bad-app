...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["episodes-details-episodes-details-module"], {
  ...
  function srcAppPagesEpisodesDetailsEpisodesDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_loading_singleton_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var EpisodesDetailsPage = /*#__PURE__*/function () {
      function EpisodesDetailsPage(activatedRoute, api, helpService, loading, favouriteService) {
      ...
      _createClass(EpisodesDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.loading.show();
          this.api.getEpisode(this.epiId).subscribe(function (res) {
            _this.episode = res[0];
          ...
          this.favouriteService.isFavouriteEpi(this.epiId).then(function (isFav) {
        ...
        value: function favouriteEpisode() {
          ...
          this.favouriteService.favouriteEpisode(this.epiId).then(function () {
        ...
        value: function unfavouriteEpisode() {
          ...
          this.favouriteService.unfavouriteEpisode(this.epiId).then(function () {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], src_app_services_helper_service__WEBPACK_IMPORTED_MODULE_4__["HelperService"], src_app_services_loading_singleton_service__WEBPACK_IMPORTED_MODULE_5__["LoadingSingletonService"], src_app_services_favourite_service__WEBPACK_IMPORTED_MODULE_6__["FavouriteService"]])], EpisodesDetailsPage);
    /***/
  }
}]);
