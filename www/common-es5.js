...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      function ApiService(http) {
        ...
        this.http = http;
        this.urlApi = "https://www.breakingbadapi.com/api";
      }
      /**
      ...
      _createClass(ApiService, [{
        key: "getPaginatedCharacters",
        value: function getPaginatedCharacters(limit, index) {
          return this.http.get("".concat(this.urlApi, "/characters?limit=").concat(limit, "&offset=").concat(index));
        }
      }, {
        key: "getCharacter",
        value: function getCharacter(id) {
          return this.http.get("".concat(this.urlApi, "/characters/").concat(id));
        }
      }, {
        key: "getCharacterAll",
        value: function getCharacterAll() {
          return this.http.get("".concat(this.urlApi, "/characters"));
        }
      }, {
        key: "getEpisodesAll",
        value: function getEpisodesAll() {
          return this.http.get("".concat(this.urlApi, "/episodes"));
        }
      }, {
        key: "getEpisode",
        value: function getEpisode(id) {
          return this.http.get("".concat(this.urlApi, "/episodes/").concat(id));
        }
      }, {
        key: "getQuotesAll",
        value: function getQuotesAll() {
          return this.http.get("".concat(this.urlApi, "/quotes"));
        }
      }, {
        key: "getDeaths",
        value: function getDeaths() {
          return this.http.get("".concat(this.urlApi, "/deaths"));
        }
      }]);
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY = "favCharacters";
    var STORAGE_FAV_EPI_KEY = "favEpisodes";
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        key: "getAllFavCharacters",
        value: function getAllFavCharacters() {
          return this.storage.get(STORAGE_KEY);
        }
      }, {
        key: "isFavourite",
        value: function isFavourite(charaId) {
          return this.getAllFavCharacters().then(function (result) {
            return result && result.indexOf(charaId) !== -1;
          });
        }
      }, {
        key: "favouriteChar",
        value: function favouriteChar(charaId) {
          var _this = this;
          ...
          return this.getAllFavCharacters().then(function (result) {
            if (result) {
              ...
              return _this.storage.set(STORAGE_KEY, [charaId]);
            }
          });
        }
      }, {
        key: "unfavouriteChar",
        value: function unfavouriteChar(charaId) {
          var _this2 = this;
        ...
        key: "getAllFavEpisodes",
        value: function getAllFavEpisodes() {
          return this.storage.get(STORAGE_FAV_EPI_KEY);
        }
      }, {
        key: "isFavouriteEpi",
        value: function isFavouriteEpi(epiId) {
          return this.getAllFavEpisodes().then(function (result) {
            return result && result.indexOf(epiId) !== -1;
          });
        }
      }, {
        key: "favouriteEpisode",
        value: function favouriteEpisode(epiId) {
          var _this3 = this;

          return this.getAllFavEpisodes().then(function (result) {
            if (result) {
              result.push(epiId);
              return _this3.storage.set(STORAGE_FAV_EPI_KEY, result);
            } else {
              return _this3.storage.set(STORAGE_FAV_EPI_KEY, [epiId]);
            }
          });
        }
      }, {
        key: "unfavouriteEpisode",
        value: function unfavouriteEpisode(epiId) {
          var _this4 = this;
          ...
          return this.getAllFavEpisodes().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE_FAV_EPI_KEY, result);
            }
          });
        }
      }]);
